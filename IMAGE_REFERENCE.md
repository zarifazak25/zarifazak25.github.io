...
|---|-----------|------|---------|-------------|
| 1 | `profile_photo.jpg` | 800x800 | index.html | Your professional headshot (square) |
...
## 🛠️ Product Development Projects (3 images)
...
- Why: Looks best for headshots

**Landscape (1200x800):**
- Used for: Everything else
- Why: Standard web image ratio (3:2)

**How to resize:**
- Use [Canva](https://canva.com) (free)
- Use [Photopea](https://photopea.com) (free online Photoshop)
- Or any photo editor

---

Print this page and check off each image as you upload it! ✓
